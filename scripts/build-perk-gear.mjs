...
const PERK_ARMOR_SET = {
  ...
  "from-the-shadows": "assassin",
  "run-and-gun": "athletic",
  parkour: "athletic",
  "light-armor": "assassin",
  "medium-armor": "enforcer",
  "heavy-armor": "raider",
